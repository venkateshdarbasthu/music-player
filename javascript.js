...
const music_list = [
    {
        ...
        name : 'UNHOLY',
        artist : 'Sam Smith',
        music : 'Unholy-\(Slowed-and-Reverb\)_320\(PagalWorldl\).mp3 '
    },
    {
        img : 'https://i1.sndcdn.com/artworks-000173935001-g1x896-t500x500.jpg',
        name : 'CLOSER',
        artist : 'One direction',
        music : 'Closer\ -\ The\ Chainsmokers-\(DJMaza\)\ \(1\).mp3'
    },
    {
